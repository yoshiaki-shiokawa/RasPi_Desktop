...
class MainView : View("Desktop App for RasPi") {
    ...
    init {
        val digitalClockThread : Thread = Thread(Runnable{Run_Digital_Clock()})
    ...
    private fun Run_Digital_Clock(){
        ...
        var second : Int = current.third
        var hour : Int = current.first
        var minute : Int = current.second
